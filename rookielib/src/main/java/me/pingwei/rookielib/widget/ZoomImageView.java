...
/**
 * Created by xupingwei on 16/5/18.
 */
...
//    private LargeImageActivity context;
...
//    public void setContext(LargeImageActivity context) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                lastXMove = -1;
                lastYMove = -1;
                if (1 == event.getPointerCount() && isMoved == false) {
//                    return super.onTouchEvent(event);   //退出图片
//                    context.finish();
                }
                isMoved = false;
                break;
